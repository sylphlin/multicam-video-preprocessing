...
description: >
  ...
  zero-split Gemini 3.8 Flash Agentic Video EDL generation (Vertex AI / GCS Primary, AI Studio Backup), FCP7 XML timeline export with NTSC fractional fps & drop-frame support (Primary), direct video rendering (Secondary),
